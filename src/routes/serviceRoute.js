...
router.get('/', apiLimiter, getAllServicesHandler);
router.get('/:id', apiLimiter, getServiceByIdHandler);
router.post('/', createLimiter, protect, authorize('admin'), createServiceHandler);
router.put('/:id', createLimiter, protect, authorize('admin'), updateServiceHandler);
router.delete('/:id', apiLimiter, protect, authorize('admin'), deleteServiceHandler);
router.patch('/:id/deactivate', apiLimiter, protect, authorize('admin'), deactivateServiceHandler);
router.patch('/:id/activate', apiLimiter, protect, authorize('admin'), activateServiceHandler);
